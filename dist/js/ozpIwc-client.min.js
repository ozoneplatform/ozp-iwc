...
var i=g;return ozpIwc.util.structuredCloneSupport()||(i=JSON.stringify(g)),this.peer.postMessage(i,"*"),this.sentBytes+=i.length,this.sentPackets++,"watch"===g.action&&(this.watchMsgMap[f]=g),g},ozpIwc.Client.prototype.isConnected=function(){return"$nobody"!==this.address},ozpIwc.Client.prototype.cancelCallback=function(a){var b=!1;return a&&(delete this.replyCallbacks[a],b=!0),b},ozpIwc.Client.prototype.on=function(a,b){return"connected"===a&&this.isConnected()?void b(this):this.events.on.apply(this.events,arguments)},ozpIwc.Client.prototype.off=function(){return this.events.off.apply(this.events,arguments)},ozpIwc.Client.prototype.disconnect=function(){this.replyCallbacks={},window.removeEventListener("message",this.postMessageHandler,!1),this.iframe&&(document.body.removeChild(this.iframe),this.iframe=null)},ozpIwc.Client.prototype.connect=function(){if(!this.connectPromise){var a=this;this.connectPromise=new Promise(function(b){a.peerUrlCheck(a.launchParams.peer,b)}).then(function(b){return a.peerUrl=b,a.peerOrigin=ozpIwc.util.determineOrigin(b),a.createIframePeer()}).then(function(){return this.postMessageHandler=function(b){if(b.origin===a.peerOrigin)try{var c=b.data;"string"==typeof c&&(c=JSON.parse(b.data)),a.receive(c),a.receivedBytes+=2*b.data.length,a.receivedPackets++}catch(d){}},window.addEventListener("message",this.postMessageHandler,!1),new Promise(function(b){a.send({dst:"$transport"},function(c){a.address=c.dst,a.events.trigger("gotAddress",a),b(a.address)})})}).then(function(){if(a.preconnectionQueue.forEach(function(b){a.send(b.fields,b.callback,b.promise)}),a.preconnectionQueue=null,a.launchParams.mailbox){var b=a.launchParams.mailbox.indexOf("/"),c=a.launchParams.mailbox.substr(0,b),d=a.launchParams.mailbox.substr(b);return new Promise(function(b){a.send({dst:c,resource:d,action:"get"},function(c){if("ok"===c.response)for(var d in c.entity)a.launchParams[d]=c.entity[d];b()})})}}).then(function(){a.events.trigger("connected")}).catch(function(a){console.log("Failed to connect to bus ",a)})}return this.connectPromise},ozpIwc.Client.prototype.createIframePeer=function(){var a=this;return new Promise(function(b){var c=function(){a.iframe=document.createElement("iframe"),a.iframe.addEventListener("load",function(){b()}),a.iframe.src=a.peerUrl+"/iframe_peer.html",a.iframe.height=1,a.iframe.width=1,a.iframe.style.setProperty("display","none","important"),document.body.appendChild(a.iframe),a.peer=a.iframe.contentWindow};"complete"===document.readyState?c():window.addEventListener("load",c,!1)})},function(){ozpIwc.Client.prototype.api=function(b){var c=this.wrapperMap[b];if(!c){var d=this.apiMap[b];c={};for(var e=0;e<d.actions.length;++e){var f=d.actions[e];c[f]=a(d.address,f,this)}this.wrapperMap[b]=c}return c.apiName=b,c};var a=function(a,b,c){return function(d,e,f){return new Promise(function(g,h){var i={dst:a,action:b,resource:d,entity:{}};for(var j in e)i[j]=e[j];c.send(i,function(a){return"ok"===a.response?g(a):/(bad|no).*/.test(a.response)&&h(a),f?f(a):!!f})})}}}();
>>>>>>> Stashed changes
