...
ozpIwc.api.intents.HandlerNode = (function (ozpIwc) {
    /**
     }
     * @class HandlerNode
     ...
     * @constructor
     */
    var HandlerNode = ozpIwc.util.extend(ozpIwc.api.base.Node, function (config) {
    ...
    HandlerNode.prototype.set = function (packet) {
        ...
        if (!dst) {
            ...
            throw new ozpIwc.api.error.BadContentError("Intent handler must supply invokeIntent.dst");
        }

        ozpIwc.api.base.Node.prototype.set.apply(this, arguments);
