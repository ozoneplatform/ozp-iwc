...
ozpIwc.api.system.Api = (function (ozpIwc) {
    /**
     ...
     */
    var Api = ozpIwc.api.createApi("system.api",function (config) {
...
//====================================================================
    ...
    Api.declareRoute({
        ...
        ozpIwc.log.debug(this.logPrefix + " handling launch data ", packet.entity);
    ...
    Api.prototype.createNodeObject = function (config) {
        return new ozpIwc.api.system.Node(config);
    };
