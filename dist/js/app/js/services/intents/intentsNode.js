 ...
 */
ozpIwc.IntentsNode.prototype.deserializeResourceFromContentType = function(serializedForm) {
    switch(this.contentType){
        case "application/vnd.ozp-intent-v1+json":
            this.resource = "/" + serializedForm.type + "/" + serializedForm.action;
            break;
        default:
            ozpIwc.ApiNode.prototype.deserializeResourceFromContentType.apply(this,serializedForm);
    }
};