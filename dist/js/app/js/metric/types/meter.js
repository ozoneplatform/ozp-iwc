...
ozpIwc.metric.types.Meter = (function (metricTypes, ozpIwc) {
     ...
     */
    var Meter = ozpIwc.util.extend(metricTypes.BaseMetric, function () {
        metricTypes.BaseMetric.apply(this, arguments);
        /**
         * @property m1Rate
         * @type {ozpIwc.metric.stats.ExponentiallyWeightedMovingAverage}
         */
        this.m1Rate = new ozpIwc.metric.stats.ExponentiallyWeightedMovingAverage(ozpIwc.metric.stats.M1_ALPHA);
        /**
         * @property m5Rate
         * @type {ozpIwc.metric.stats.ExponentiallyWeightedMovingAverage}
         */
        this.m5Rate = new ozpIwc.metric.stats.ExponentiallyWeightedMovingAverage(ozpIwc.metric.stats.M5_ALPHA);
        /**
         * @property m15Rate
         * @type {ozpIwc.metric.stats.ExponentiallyWeightedMovingAverage}
         */
        this.m15Rate = new ozpIwc.metric.stats.ExponentiallyWeightedMovingAverage(ozpIwc.metric.stats.M15_ALPHA);
        /**
         * @property startTime
         * @type {Number}
         */
