...
ozpIwc.metric.types.Timer = (function (metricTypes, ozpIwc) {
    /**
     * @class Timer
     * @namespace ozpIwc
     ...
     * @type {Function}
     */
    var Timer = ozpIwc.util.extend(metricTypes.BaseMetric, function () {
        metricTypes.BaseMetric.apply(this, arguments);
        /**
         * @property meter
         * @type {ozpIwc.metric.types.Meter}
         */
        this.meter = new ozpIwc.metric.types.Meter();

        /**
         * @property histogram
         * @type {ozpIwc.metric.types.Histogram}
         */
        this.histogram = new ozpIwc.metric.types.Histogram();
    });
