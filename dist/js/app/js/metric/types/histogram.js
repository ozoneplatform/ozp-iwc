...
ozpIwc.metric.types.Histogram = (function (metricTypes, ozpIwc) {
    /**
     * @class Histogram
     * @namespace ozpIwc.metric.types
     * @extends ozpIwc.metric.types.BaseMetric
     */
    var Histogram = ozpIwc.util.extend(metricTypes.BaseMetric, function () {
         ...
         */
        this.sample = new ozpIwc.metric.stats.ExponentiallyDecayingSample();
        this.clear();
    });
