...
ozpIwc.policyAuth.points.PIP = (function (policyAuth, ozpIwc) {
     ...
     * @constructor
     */
    var PIP = ozpIwc.util.extend(policyAuth.elements.SecurityAttribute, function (config) {
    ...
    PIP.prototype.attributeUnion = function (attr1, attr2) {
        var rv = {};
        ozpIwc.util.object.eachEntry(attr1, function (key, value) {
        ...
        ozpIwc.util.object.eachEntry(attr2, function (key, value) {
            if (!(key in rv)) {
                rv[key] = value;
