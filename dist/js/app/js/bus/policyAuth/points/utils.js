 ...
 * @type {Object}
 */
ozpIwc.policyAuth.points.utils = (function (ozpIwc) {
    /**
    ...
    var formatAttributes = function (attributes, pip) {
        var asyncAction = new ozpIwc.util.AsyncAction();
        if (!pip) {
        ...
        ozpIwc.util.AsyncAction.all(asyncs).success(function (attrs) {
            var retObj = {};
            for (var i in attrs) {
    ...
    var formatRequest = function (request, pip) {
        ...
        ozpIwc.util.AsyncAction.all(asyncs)
    ...
    var formatCategories = function (categoryObj, pip) {
        ...
        ozpIwc.util.AsyncAction.all(categoryAsyncs)
