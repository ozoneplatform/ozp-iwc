 ...
 * @static
 */
ozpIwc.policyAuth.policies = (function (policies, ozpIwc) {
...
//---------------------------------------------------------
     ...
     */
     var defaultPolicy = function (request, action) {
        ...
        } else if (!ozpIwc.util.objectContainsAll(request.subject, request.resource, policies.implies)) {
            return "Deny";
        } else {
            return "Permit";
        }
...
//---------------------------------------------------------
    ...
    return policies;
}(ozpIwc.policyAuth.policies || {}, ozpIwc));
