...
ozpIwc.api.base.Api = (function (ozpIwc) {
    /**
    ...
    var Api = function (config) {
         ...
         */
        this.participant = config.participant || new ozpIwc.transport.participant.Client({
                'internal': true,
...
//--------------------------------------------------
    ...
    var queueForCoordination = function (apiBase, promise) {
        ...
        apiBase.leaderPromise.then(function (pkt) {
            ozpIwc.log.info("[" + apiBase.name + "][" + apiBase.participant.address + "] Now operating");
            var resolve;
    ...
    var resolveChangedNodes = function (apiBase, packetContext) {
        ...
        ozpIwc.util.object.eachEntry(apiBase.changeList, function (resource, snapshot) {
    ...
    var removeDeadWatchers = function (apiBase, address) {
        ...
        ozpIwc.util.object.eachEntry(apiBase.watchers, function (resource, array) {
            for (var i in array) {
    ...
    var receiveRequestPacket = function (apiBase, packetContext) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                ...
                if (!e || !e.errorAction) {
                    ozpIwc.log.error(apiBase.logPrefix, "Unexpected error: ", e, " packet= ", packet);
                }
                var packetFragment = {
                    'src': apiBase.name,
...
//===============================================================
    ...
    Api.prototype.changedHandler = function (node, entity, packetContext) {
        ...
        var lifespanFns = ozpIwc.api.Lifespan.getLifespanFunctionality(node.lifespan);
    ...
    Api.prototype.disconnectHandler = function (address) {
        var self = this;
        ozpIwc.util.object.eachEntry(self.data, function (resource, node) {
            var lifespanFns = ozpIwc.api.Lifespan.getLifespanFunctionality(node.lifespan);
    ...
    Api.prototype.createDeathScream = function () {
        return {
            ...
            data: ozpIwc.util.object.eachEntry(this.data, function (k, v) {
    ...
    Api.prototype.createNodeObject = function (config, NodeType) {
        if (NodeType) {
            ...
            return new ozpIwc.api.base.Node(config);
        }
    };
...
//===============================================================
    ...
    Api.prototype.matchingNodes = function (prefix) {
        return ozpIwc.util.object.values(this.data, function (k, node) {
    ...
    Api.prototype.defaultRoute = function (packet, context) {
        switch (context.defaultRouteCause) {
            case "nonRoutablePacket": // packet doesn't have an action/resource, so ignore it
                return;
            case "noAction":
                throw new ozpIwc.api.error.BadActionError(packet);
            case "noResource":
                throw new ozpIwc.api.error.BadResourceError(packet);
            default:
                throw new ozpIwc.api.error.BadRequestError(packet);
        }
    };
    ...
    Api.prototype.loadFromEndpoint = function (endpoint, headers) {
        ...
        return endpoint.get("/").then(function (data) {
            ...
            unknownLinks = unknownLinks.filter(function (href) {
                return ozpIwc.util.object.values(self.data, function (k, node) {
