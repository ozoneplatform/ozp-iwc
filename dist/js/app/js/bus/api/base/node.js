...
ozpIwc.api.base.Node = (function (ozpIwc) {
    /**
    ...
    var Node = function (config) {
         ...
         * @default false
         */
        var lifespanParsed = ozpIwc.api.Lifespan.getLifespan(this, config);
        if (lifespanParsed) {
            ...
            this.lifespan = new ozpIwc.api.Lifespan.Ephemeral();
        }
    ...
    Node.prototype.getSelfUri = function () {
        ...
        if (this.uriTemplate && ozpIwc.api.uriTemplate) {
            var template = ozpIwc.api.uriTemplate(this.uriTemplate);
            if (template) {
    ...
    Node.prototype.set = function (packet) {
        ...
        this.lifespan = ozpIwc.api.Lifespan.getLifespan(this, packet) || this.lifespan;
