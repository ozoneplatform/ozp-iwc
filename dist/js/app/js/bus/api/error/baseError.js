 ...
 */
ozpIwc.api.error.BaseError = (function (ozpIwc) {
    /**
     ...
     */
    var BaseError = ozpIwc.util.extend(Error, function (action, message) {
    ...
    BaseError.subclass = function (response) {
        return ozpIwc.util.extend(BaseError, function (message) {
