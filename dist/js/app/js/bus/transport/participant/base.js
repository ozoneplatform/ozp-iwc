...
ozpIwc.transport.participant.Base = (function (ozpIwc) {
    ...
    var Base = function () {
         ...
         * @default {}
         */
        this.permissions = new ozpIwc.policyAuth.elements.SecurityAttribute();
         ...
         */
        this.sentPacketsMeter = new ozpIwc.metric.types.Meter();
         ...
         * @type ozpIwc.metric.types.Meter
         */
        this.receivedPacketsMeter = new ozpIwc.metric.types.Meter();
         ...
         * @type ozpIwc.metric.types.Meter
         */
        this.forbiddenPacketsMeter = new ozpIwc.metric.types.Meter();
        this.latencyInTimer = new ozpIwc.metric.types.Meter();
        this.latencyOutTimer = new ozpIwc.metric.types.Meter();
        ...
        ozpIwc.util.addEventListener("beforeunload", function () {
            ...
            self.send = function (originalPacket, callback) {
                ...
                ozpIwc.transport.participant.Base.prototype.send.call(self, packet);
    ...
    Base.prototype.receiveFromRouter = function (packetContext) {
        ...
        ozpIwc.authorization.isPermitted(request, this)
            .success(function () {
                ozpIwc.policyAuth.points.utils.formatCategory(packetContext.packet.permissions, ozpIwc.authorization.pip)
