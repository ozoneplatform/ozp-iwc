...
ozpIwc.transport.participant.Internal = (function (ozpIwc) {
     ...
     */
    var Internal = ozpIwc.util.extend(ozpIwc.transport.participant.Base, function (config) {
        config = config || {};
    ...
    Internal.prototype.send = function (originalPacket, callback) {
        ...
        var self = this;
        var send = ozpIwc.transport.participant.Base.prototype.send;
